...
from .expr import ExpressionStatement, PrintStatement, Visitor, \
    Binary, Grouping, Literal, Unary, Expr, Statement, VarStatement, \
    Variable, Assign, BlockStatement, IfStatement, Logical, WhileStatement, \
    Call, FunctionStatement, ReturnStatement
...
class Interpreter(Visitor):
    ...
    def visit_call_expr(self, expr: Call) -> Any:
        ...
        if arguments_size != arity:
            raise RuntimeErrorL(
                expr.paren,
                f"Expected {arity} arguments but got {arguments_size}"
            )
